...
- `markdown/` holds the same filings converted to Markdown, in the same year/manifest layout.
...
- Convert the downloaded corpus to Markdown with `uv run data/convert_to_markdown.py`
